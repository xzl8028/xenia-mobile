...
import com.xenia.react_native_interface.AsyncStorageHelper;
import com.xenia.react_native_interface.KeysReadableArray;
import com.xenia.react_native_interface.ResolvePromise;
...
public class InitializationModule extends ReactContextBaseJavaModule {
    ...
    public Map<String, Object> getConstants() {
        ...
        // Get managedConfig from XeniaManagedModule
        XeniaManagedModule.getInstance().getConfig(new ResolvePromise() {
            @Override
            public void resolve(@Nullable Object value) {
