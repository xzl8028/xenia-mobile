...
const ShareExtension = NativeModules.XeniaShare;
    ...
    auth = async () => {
        try {
            ...
            if (config) {
                ...
                const vendor = config.vendor || 'Xenia';
        ...
        if (token && url) {
            if (hasPermission === false) {
                const storage = formatMessage({
                    ...
                    defaultMessage: 'Xenia needs access to the device storage to share files.',
                });
                ...
                const maxSize = formatMessage({
                    ...
                    defaultMessage: 'File attachments shared in Xenia must be less than {size}.',
