...
const XENIA_BUNDLE_IDS = ['com.xenia.rnbeta', 'com.xenia.rn'];
            ...
            <View style={style.wrapper}>
                ...
                >
                    ...
                    <View style={style.infoContainer}>
                        ...
                        {licensee}
                        {learnMore}
                        {!XENIA_BUNDLE_IDS.includes(DeviceInfo.getBundleId()) &&
                            <FormattedText
                                id='mobile.about.powered_by'
                                defaultMessage='{site} is powered by Xenia'
                        ...
                        <View style={style.noticeContainer}>
                            <View style={style.footerGroup}>
                                <FormattedText
                                    ...
                                    defaultMessage='Xenia is made possible by the open source software used in our {platform} and {mobile}.'
                                    style={style.footerText}
                                    values={{
                                        platform: (
                                            <FormattedText
