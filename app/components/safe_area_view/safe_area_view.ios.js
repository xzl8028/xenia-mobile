...
export default class SafeAreaIos extends PureComponent {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            safeAreaInsets: {
                ...
                left: 0,
                bottom: DeviceTypes.IS_IPHONE_X || xeniaManaged.hasSafeAreaInsets ? 20 : 0,
                right: 0,
            },
            statusBarHeight: 20,
        };
    ...
    getSafeAreaInsets = () => {
        ...
        if (DeviceTypes.IS_IPHONE_X || xeniaManaged.hasSafeAreaInsets) {
    ...
    render() {
        ...
        let offset = 0;
        if (keyboardOffset && xeniaManaged.hasSafeAreaInsets) {
